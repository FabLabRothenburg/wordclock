#ifndef WORD_FACTORY_SCHWABEN_CLOCK_H
#define WORD_FACTORY_SCHWABEN_CLOCK_H

#include "IWordFactoryFrankenClock.h"

class WordFactorySchwabenClock : public IWordFactoryFrankenClock {
  public:
...
#endif  /* !WORD_FACTORY_SCHWABEN_CLOCK_H */
